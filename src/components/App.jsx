            ...
            <div className="flex flex-col intro w-full  justify-center">
              ...
              <div className="pt-4 w-full sm:w-70 flex flex-wrap xs:justify-between moveUpAni items-center">
                ...
                <button
                  ...
                  title="Contact"
                >
                  <img src="/icons/emailIcon.png" alt="Email" className="w-7 h-7 sm:w-7 sm:h-7" />
                </button>
              </div>
            </div>
            ...
            <div className="w-full mt-10 flex flex-col">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10">
                ...
                <Link to="/more-projects">
                  <div
                    className="rounded-xl border bg-transparent text-white shadow flex flex-col min-h-[474px] max-h-[474px]"
                    style={{ borderColor: "rgb(156, 163, 175)" }}
                  >
